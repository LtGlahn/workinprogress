...
def finnLysarmatur( relasjonstre, egenskaper=None ): 
    ...
    for enRelasjonstype in relasjonstre: 
        for etObjekt in enRelasjonstype['vegobjekter']: 
            ...
            if 'metadata' in etObjekt and etObjekt['metadata']['type']['navn'] == 'Lysarmatur':
...
if __name__ == '__main__': 
    ...
    # Lagrer til excel 
    with pd.ExcelWriter( 'elanlegg_lysarmatur_OvreEiker.xlsx') as writer: 

        # Fjerner geometrikolonner fra excel 
        col_eldf = [ x for x in list( eldf.columns) if not 'geometr' in x.lower()  ]
        col_lys =  [ x for x in list( lysdf.columns) if not 'geometr' in x.lower() ]
...
# versjon                                int64
# startdato                             object
# Avskjerming, materiale                object
# Dimming                               object
# Produsent, driver                     object
# Antall armaturer i belysningspkt       int64
# Optikk                                object
# Inngår i nødsystemet                  object
# Lyskilde type                         object
# Konstant lysutbytte                   object
# Utskiftbare lyskilder                 object
# Eier                                  object
# Antall lyskilder per armatur           int64
# Vedlikeholdsansvarlig                 object
# Avskjerming, type                     object
# Lyskilde sist skiftet                 object
# Effekt                               float64
# Produsent, armatur                    object
# ElAnlegg_Bruksområde                  object
# ElAnlegg_nvdbId                        int64
# ElAnlegg_geom                         object
# relasjoner                            object
# vegsystemreferanser                   object
# stedfestinger                         object
# vegsegmenter                          object
# geometri                              object
# Etableringsår                        float64
# Høyde over veg                       float64
# Utstyrsklasse                         object
# Produktnavn, armatur                  object
...
# ElAnlegg_Bruksområde                object
# Etableringsår                        int64
# Antall NVDB-objekter lysarmatur    float64
# Samlet effekt, lysarmatur          float64
# relasjoner                          object
# vegsystemreferanser                 object
# stedfestinger                       object
# vegsegmenter                        object
# Effekt                             float64
# Nettsystem                          object
# Jordelektrode                       object
# Jordfeilbryter                      object
# Jordfeilvarsling                    object
# Spenning                            object
# Utgår_Anleggsnummer                 object
# Vedlikeholdsansvarlig               object
# Plassering, måler                   object
# Bygget etter forskrift              object
# Bygget etter norm                   object
# Eier                                object
# Fjernavlesing                       object
# Inngår i nødsystemet                object
# Måling type                         object
# Tilleggsinformasjon                 object
# I tunnel                            object
# Tunnelløp ID                       float64
# Prosjektreferanse                   object
# Eier, navn                          object

# https://vegkart.atlas.vegvesen.no/#valgt:272388137:60